  ...
  reducers: {
    ...
    editTodo: (
      ...
      state.todos.filter(todo => { 
        if(state.selectedTodo !== null && todo.id === state.selectedTodo.id) {
...
export const { addTodo, deleteTodo, selectTodo, editTodo, displayAddTodo, displayEditTodo, clearSelectedTodo } = todoSlice.actions
